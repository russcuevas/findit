        ...
        <div class="flex-1 p-6 overflow-y-auto">
            <div class="rounded-xl p-6 border border-gray-700" style="background: linear-gradient(to bottom, #13212B, #13212B);">
                <div class="flex space-x-4 mb-4">
                    ...
                    <a href="non_verified_users.php" class="px-5 py-2.5 rounded-full text-sm font-medium bg-black ">
                        Non-verified Users
                    </a>
                    ...
                    <table id="usersTable" class="w-full text-left">
                        <thead>
                            <tr class="border-b border-gray-600">
                                <th class="pb-3 font-medium text-gray-300" style="font-size: 15px;">#</th>
                                <th class="pb-3 text-center font-medium text-gray-300" style="font-size: 15px;">Name</th>
                                <th class="pb-3 text-center font-medium text-gray-300" style="font-size: 15px;">Mobile Number</th>
                                <th class="pb-3 text-center font-medium text-gray-300" style="font-size: 15px;">Email Address</th>
                                <th class="pb-3 text-center font-medium text-gray-300" style="font-size: 15px;">Registration Date</th>
                                <th class="pb-3 text-center font-medium text-gray-300" style="font-size: 15px;">Actions</th>
                            </tr>
                        </thead>
                        <tbody class="text-sm">
